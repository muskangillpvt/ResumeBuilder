...
function Home(){
    return(
        <div>
            ...
            <p className="text-sm text-slate-500 text-center mt-2 max-w-md mx-auto">Everything you need to keep your desired job in your full control</p>
            
            <div className="pb-8 flex items-center justify-center flex-wrap gap-6 mt-20 px-4 md:px-0">
                <div className="flex flex-col text-center items-center justify-center rounded-xl p-6 border border-violet-200 gap-6 max-w-sm">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-slate-600">Get instant insights into your resumes with live dashboards.</p>
                    </div>
                </div>
                <div className="flex flex-col text-center items-center justify-center rounded-xl p-6 border border-green-200 gap-6 max-w-sm">
                    ...
                    <div className="space-y-2">
                        <h3 className="text-base font-semibold text-slate-700">User personalized with security</h3>
                        <p className="text-sm text-slate-600">End-to-end encryption, and no sharing of your personal data.</p>
                    </div>
                </div>
                <div className="flex flex-col text-center items-center justify-center rounded-xl p-6 border border-orange-200 gap-6 max-w-sm">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-slate-600">Export professional, audit-ready financial resumes from AI.</p>
                    </div>
                </div>
            </div>
        </div>
